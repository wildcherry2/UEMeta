...
namespace UEMeta::Testing::Types {
    ...
    extern "C" {
    extern int PlainExternCNoneWithoutDefault;
    }
    extern "C" {
    extern int PlainExternCNoneWithDefault = 17;
    }
    extern "C" {
    extern constexpr int PlainExternCConstexprWithDefault = 17;
    }
    ...
    extern "C" {
    extern int* PointerExternCNoneWithoutDefault;
    }
    extern "C" {
    extern int* PointerExternCNoneWithDefault = nullptr;
    }
    extern "C" {
    extern constexpr int* PointerExternCConstexprWithDefault = nullptr;
    }
    ...
    extern "C" {
    extern int** DoublePointerExternCNoneWithoutDefault;
    }
    extern "C" {
    extern int** DoublePointerExternCNoneWithDefault = nullptr;
    }
    extern "C" {
    extern constexpr int** DoublePointerExternCConstexprWithDefault = nullptr;
    }
    ...
    extern "C" {
    extern int ArrayExternCNoneWithoutDefault[2];
    }
    extern "C" {
    extern int ArrayExternCNoneWithDefault[2] = {17};
    }
    extern "C" {
    extern constexpr int ArrayExternCConstexprWithDefault[2] = {17};
    }
    ...
    extern "C" {
    extern int& ReferenceExternCNoneWithoutDefault;
    }
    extern "C" {
    extern int& ReferenceExternCNoneWithDefault = PlainExternNoneWithoutDefault;
    }
    extern "C" {
    extern constexpr int& ReferenceExternCConstexprWithDefault = PlainExternNoneWithoutDefault;
    }
