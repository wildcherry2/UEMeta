...
int UEMeta::Config::Initialize(int argc, char **argv) {
    ...
    app.add_option("-cc,--compile-commands", cfg.cc_path, "Path of the compile_commands.json generated by UBT")
        ->required()->check([](const auto& opt) -> std::string {
    ...
    auto ss_option = app.add_option("-ss,--split-strategy", cfg.split_strategy,
    ...
    auto parent_dir_options = app.add_option("-pd,--parent-directories", cfg.pd_paths, "Semicolon-separated list of directories to use as groups for ASTs within a JSON.")
    ...
    app.add_option("-cl, --clang", cfg.clang_path, "Path to the clang-cl executable (windows) or clang (everything else).")
