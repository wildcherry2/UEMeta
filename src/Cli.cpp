...
int UEMeta::Config::Initialize(int argc, char **argv) {
    ...
    auto parent_dir_options = app.add_option("--parent-directories", cfg.pd_paths, "Space-separated list of directories to use as groups for ASTs within a JSON.")
    ...
    //todo bundle clang files from deps
